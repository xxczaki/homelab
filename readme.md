...
|---|---|---|
| [argo-cd](apps/argo-cd) | Helm | v9.4.9 |
| [cilium](apps/cilium) | Helm | v1.19.1 |
| [discord-bot](apps/discord-bot) | Helm | v0.17.7 |
| [k8s-monitoring](apps/k8s-monitoring) | Helm | v3.8.1 |
| [longhorn](apps/longhorn) | Helm | v1.11.0 |
| [openclaw](apps/openclaw) | Git | v0.10.25 |
