...
| ------------------------------------- | --------------- | ------- |
| [argo-cd](apps/argo-cd)               | Helm            | 9.4.7   |
| [cilium](apps/cilium)                 | Helm            | 1.19.1  |
| [discord-bot](apps/discord-bot)       | Helm            | 0.17.2  |
| [k8s-monitoring](apps/k8s-monitoring) | Helm            | 3.8.1   |
| [longhorn](apps/longhorn)             | Helm            | 1.11.0  |
| [openclaw](apps/openclaw)             | Git             | 0.10.25 |
| [pi-hole](apps/pi-hole)               | Helm            | 2.35.0  |
| [sealed-secrets](apps/sealed-secrets) | Helm            | 2.18.3  |
| [system-upgrade](apps/system-upgrade) | Git + Kustomize | v0.19.0 |
| [tailscale](apps/tailscale)           | Helm            | 1.94.2  |
